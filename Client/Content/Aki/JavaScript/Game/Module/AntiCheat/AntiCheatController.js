...
((exports.AntiCheatController = AntiCheatController).W9e = 0),
  (AntiCheatController.K9e = 0),
  (AntiCheatController.F9e = () => {
  ...
  (AntiCheatController.V9e = () => {
    var e = TimeUtil_1.TimeUtil.GetServerTimeStamp(),
      t =
        (0.001 * (e - AntiCheatController.K9e) >= HEARTBEAT_REPORT_INTERVAL &&
          ...
          (AntiCheatController.K9e = e)),
        e - AntiCheatController.W9e),
      r = Heartbeat_1.Heartbeat.GetHeartbeatInterval(),
      r = HEARTBEAT_EXCEPTION_FACTOR * r;
    0 < AntiCheatController.W9e &&
      t <= r &&
