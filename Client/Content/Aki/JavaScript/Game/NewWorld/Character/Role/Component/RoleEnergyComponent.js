...
var __decorate = this && this.__decorate || function(t, e, o, r) {
    ...
    if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) s = Reflect.decorate(t, e, o, r);
        ...
        for (var c = t.length - 1; 0 <= c; c--)(n = t[c]) && (s = (i < 3 ? n(s) : 3 < i ? n(e, o, s) : n(e, o)) || s);
...
let RoleEnergyComponent = class RoleEnergyComponent extends EntityComponent_1.EntityComponent {
    constructor() {
        super(...arguments), this.U6r = void 0, this.yte = void 0, this.HXo = (t, e, o) => {
...
RoleEnergyComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(80)], RoleEnergyComponent), exports.RoleEnergyComponent = RoleEnergyComponent;
