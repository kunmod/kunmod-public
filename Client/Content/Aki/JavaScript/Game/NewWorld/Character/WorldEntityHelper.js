...
//   PawnInteractNewComponent_1 = require("../Pawn/Component/PawnInteractNewComponent"), // remove old
  PawnInteractNewComponent_1 = require("../Pawn/Component/PawnInteractNewComponent_New"), // add new
...
//   CharacterSkillCdComponent_1 = require("./Common/Component/Skill/CharacterSkillCdComponent"), // remove old
  CharacterSkillCdComponent_1 = require("./Common/Component/Skill/CharacterSkillCdComponent_New"), // add new
  ...
  NpcTickManageComponent_1 = require("./Npc/Component/NpcTickManageComponent"),
  ...
  RoleFormationComponent_1 = require("./Role/Component/RoleFormationComponent"),
...
class WorldEntityHelper {
  static Initialize() {
    return this.oeo(), this.neo(), this.seo(), !0;
  }
  static Clear() {
    return (
      this.ComponentPriority.clear(), this.aeo.clear(), this.heo.clear(), !0
    );
  }
    ...
    switch (n.EntityType) {
      ...
      case Protocol_1.Aki.Protocol.EEntityType.Vision:
        if (((e.Priority = VISION_PRIORITY), this.GetVisionComponentRecord(e)))
          break;
        return;
      case Protocol_1.Aki.Protocol.EEntityType.Animal:
        if (((e.Priority = OTHER_PRIORITY), this.GetAnimalComponentRecord(e)))
          break;
        return;
      case Protocol_1.Aki.Protocol.EEntityType.Custom:
        if (((e.Priority = OTHER_PRIORITY), this.GetCustomComponentRecord(e)))
          break;
        return;
      case Protocol_1.Aki.Protocol.EEntityType.Npc:
        switch (((e.Priority = NPC_PRIORITY), n.SubEntityType || 0)) {
          case 1:
            this.leo &&
        ...
        if (t) (e.ComponentsKey = o), this.ceo(e);
        else {
          if (!this.GetNpcComponentRecord(e)) return;
          o = e.ComponentsKey;
        }
        break;
      case Protocol_1.Aki.Protocol.EEntityType.SceneItem:
        if (
    ...
    if (exports.USE_ENTITY_POOL) {
      ...
      if (n.IsNpc())
        switch (n.GetSubEntityType()) {
          case 1:
            this.leo = n.GetComponentKey();
            break;
          case 2:
            this._eo = n.GetComponentKey();
            break;
          default:
            this.ueo = n.GetComponentKey();
        }
  ...
  static GetRoleComponentRecord(e) {
    ...
    if (!e.AddComponent(RoleFormationComponent_1.RoleFormationComponent))
      return !1;
  ...
  static GetSceneItemComponentRecord(n) {
    ...
    return !(
      (n.ComponentDataMap.get("DropComponentPb") &&
        !n.AddComponent(
  ...
  static neo() {
    this.aeo.set(0, [
      ...
      NpcTickManageComponent_1.NpcTickManageComponent,
    ]),
      this.aeo.set(1, [
        SimpleNpcActorComponent_1.SimpleNpcActorComponent,
