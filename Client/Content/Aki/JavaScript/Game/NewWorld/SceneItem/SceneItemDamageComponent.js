  ...
  (SceneItemDamageComponent_1 = class SceneItemDamageComponent extends (
    ...
    OnInitData(e) {
      var e = e.GetParam(SceneItemDamageComponent_1)[0],
        e =
          ((this.Lo = e),
          (this.U6r = this.Entity.GetComponent(1)),
          (this.jan = Vector_1.Vector.Create(
      ...
      this.Fan = t || 100;
      if (ModManager_1.ModManager.Settings.AutoMine) {
    ...
    OnStart() {
      return (
        ...
        (this.$sn = this.Entity.GetComponent(137)),
        this.$sn.RegisterComponent(this, this.Lo),
        (this.Han = (e) => {
          this.qnn(e);
        }),
    ...
    qnn(e) {
      if (this.Lo.MatchRoleOption && 0 < this.Lo.MatchRoleOption.length) {
        if (
          !FormationControl_1.FormationControl.IsMatchRoleOption(
            this.Lo.MatchRoleOption
          )
        )
          return;
      } else if (ModelManager_1.ModelManager.FormationModel.IsPhantomFormation)
        return;
    ...
    GetHitPoint() {
      ...
      return (
        this.U6r.ActorForwardProxy.Multiply(e.X, i),
        t.AdditionEqual(i),
        this.U6r.ActorRightProxy.Multiply(e.Y, i),
        t.AdditionEqual(i),
        this.U6r.ActorUpProxy.Multiply(e.Z, i),
        t.AdditionEqual(i),
        this.U6r.ActorLocationProxy.Addition(t, t),
        t
      );
    }
    GetMaxDurablePoint() {
